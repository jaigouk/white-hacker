...
Run: uv run --with jsonschema --with pytest pytest .claude/skills/sec-report/scripts/tests/
...
FIXTURE = Path(__file__).resolve().parents[5] / "docs" / "research" / "poc-floor-review" / "run" / "triage.deduped.json"
