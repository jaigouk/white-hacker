...
Skills live in `.claude/skills/`. If a skill is not yet installed, perform its job inline
...
## What to check — categories (full detail in `.claude/skills/_shared/reference/`)
...
- **Registry, not requirements:** the known tools live in
  `.claude/skills/_shared/reference/tool-registry.md` (examples *today*: Opengrep, OSV-Scanner,
